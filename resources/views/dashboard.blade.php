                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img class="" src="assets/images/products/pro1.png"
                                                    alt="user">
                                            </td>
                                            <td>
                                                Chair
                                        ...
                                        <tr>
                                            <td>
                                                <img class="" src="assets/images/products/pro2.png"
                                                    alt="user">
                                            </td>
                                            <td>
                                                Mobile
                                        ...
                                        <tr>
                                            <td>
                                                <img class="" src="assets/images/products/pro3.png"
                                                    alt="user">
                                            </td>
                                            <td>
                                                LED
                                        ...
                                        <tr>
                                            <td>
                                                <img class="" src="assets/images/products/pro4.png"
                                                    alt="user">
                                            </td>
                                            <td>
                                                Chair
